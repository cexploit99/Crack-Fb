...
╚██████╗██║  ██║██║  ██║╚██████╗██║  ██╗    ██║     ██████╔╝    
 ╚═════╝╚═╝  ╚═╝╚═╝  ╚═╝ ╚═════╝╚═╝  ╚═╝    ╚═╝     ╚═════╝                                                                
                       {u}▪︎{k}▪︎{h}▪︎{sir} CRACK FACEBOOK Cx99  {x}{u}▪︎{k}▪︎{h}▪︎{x}''')
#--------------------[ BAGIAN-MASUK ]--------------#
def login123():
	os.system('clear')
	banner()
...
def menu(name,id):
	...
	print('')
	print('\x1b[1;95m[\x1b[1;95m▪︎\x1b[1;95m] \x1b[1;95mAuthor      : \x1b[1;97mCx99 \33[m(\x1b[0;97mExploit99\33[m)')
	print('\x1b[1;95m[\x1b[1;95m▪︎\x1b[1;95m] \x1b[1;95mGithub      : \x1b[1;97mCx99')
